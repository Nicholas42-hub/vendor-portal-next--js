    ...
    <div className="container mx-auto py-6">
      ...
      >
        ...
        >
          ...
          {/* Filters container - with even spreading */}
          <div
            className="mb-6 overflow-x-auto bg-[rgb(240,245,250)] w-full"
            style={{ scrollbarWidth: "thin" }}
          >
            <div className="filter-wrapper w-full pb-2 bg-[rgb(240,245,250)]">
              <div className="flex w-full justify-between overflow-x-auto">
                ...
                <StatusFilter
                  ...
                  dataStatus="Manager Approval"
                  label="Manager Approval"
                  count={statusCounts["Manager Approval"]}
                  isActive={currentFilter === "Manager Approval"}
                  onClick={handleFilterChange}
                />
                <StatusFilter
                  id="pending-exco-approval"
                  dataStatus="Exco Approval"
                  label="Exco Approval"
                  count={statusCounts["Exco Approval"]}
                  isActive={currentFilter === "Exco Approval"}
                  onClick={handleFilterChange}
                />
                <StatusFilter
                  id="pending-cfo-approval"
                  dataStatus="CFO Approval"
                  label="CFO Approval"
                  count={statusCounts["CFO Approval"]}
                  isActive={currentFilter === "CFO Approval"}
                  onClick={handleFilterChange}
                />
                <StatusFilter
                  id="completed"
                ...
                <tbody id="crmDataTableBody">
                  {filteredData.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan={5}
                        className="p-4 text-center text-[#5E5E5E]"
                      >
                        No records found.
                      </td>
                    </tr>
